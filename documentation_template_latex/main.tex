...
\titleformat{\chapter}{\huge\bfseries}{}{1em}{\makebox[17mm][l]{\thechapter}}
\titleformat{\section}{\Large\bfseries}{}{1em}{\makebox[17mm][l]{\thesection}}
\titleformat{\subsection}{\bfseries}{}{1em}{\makebox[17mm][l]{\thesubsection}}
\titleformat{\subsubsection}{\itshape}{\thesubsubsection}{1em}{\makebox[17mm][l]{\thesubsubsection}}
...
\newcommand\PageNumberWithTotal{\thepage/\pageref*{LastPage}}
...
% The default page style is set to empty in order to make the front page clutter free.
\pagestyle{empty}

% The document will switch to the proper page style automatically.
\preto\frontmatter{\pagestyle{plain}}
\preto\mainmatter{\pagestyle{main}}
\preto\backmatter{\pagestyle{plain}}
